...
public class UserListFragment extends Fragment {
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        mUserListAdapter.setmOnItemClickListener(new UserListAdapter.OnitemClickListener() {
            @Override
    ...
    public void onResume() {
        ...
        mViewModel.getmAllUser().observe(getViewLifecycleOwner(), new Observer<Set<User>>() {
            @Override
